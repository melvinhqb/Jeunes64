            ...
            <form action="new_ref.php" method="post">
                ...
                <div class="checkbox-list">
                    <div class="checkbox-group">
                        <input type="checkbox" id="autonome" name="autonome"<?php if(isset($_POST['autonome'])) echo 'checked'; ?>>
                        <label for="autonome">Autonome</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="analyse" name="analyse"<?php if(isset($_POST['analyse'])) echo 'checked'; ?>>
                        <label for="analyse">Capable d'anlyse et de sinthèse</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="ecoute" name="ecoute"<?php if(isset($_POST['ecoute'])) echo 'checked'; ?>>
                        <label for="ecoute">A l'écoute</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="organise" name="organise"<?php if(isset($_POST['organise'])) echo 'checked'; ?>>
                        <label for="organise">Organisé</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="passionne" name="passionne"<?php if(isset($_POST['passionne'])) echo 'checked'; ?>>
                        <label for="passionne">Passionné</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="fiable" name="fiable"<?php if(isset($_POST['fiable'])) echo 'checked'; ?>>
                        <label for="fiable">Fiable</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="patient" name="patient"<?php if(isset($_POST['patient'])) echo 'checked'; ?>>
                        <label for="patient">Patient</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="reflechi" name="reflechi"<?php if(isset($_POST['reflechi'])) echo 'checked'; ?>>
                        <label for="reflechi">Réfléchi</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="responsable" name="responsable"<?php if(isset($_POST['responsable'])) echo 'checked'; ?>>
                        <label for="responsable">Responsable</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="sociable" name="sociable"<?php if(isset($_POST['sociable'])) echo 'checked'; ?>>
                        <label for="sociable">Sociable</label>
                    </div>
                    <div class="checkbox-group">
                        <input type="checkbox" id="optimiste" name="optimiste"<?php if(isset($_POST['optimiste'])) echo 'checked'; ?>>
